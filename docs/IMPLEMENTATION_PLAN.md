...
- A generated character/VFX direction board defines the target silhouette, palette, layering, and effects language, and identity-locked neutral/run/jump assets now implement that direction in the runtime.
